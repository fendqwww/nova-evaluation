...
export function CoachView() {
  ...
  return (
    <PageContainer className="flex flex-col gap-4">
      ...
      <div className="sticky bottom-[calc(var(--bottom-nav-height)+var(--app-safe-bottom))] -mx-4 flex flex-col gap-2.5 border-t border-border bg-background/85 px-4 pb-3 pt-3 backdrop-blur-xl">
        <CoachQuickActions
