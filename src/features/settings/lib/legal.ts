  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "Заметки коуча о ваших предпочтениях: то, что вы сами рассказали о себе в разговоре — например, что не любите бег или тренируетесь по утрам. Коуч опирается на них в следующих разговорах. Очистка истории коуча в настройках удаляет и их.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Когда вы задаёте вопрос AI Coach — и один раз в день, когда коуч сам готовит разбор дня, — в Google (Gemini API) отправляются текст вопроса, сводка ваших показателей за последние дни и заметки коуча о ваших предпочтениях, чтобы сформировать ответ. Фото туда не отправляются.",
