 ...
 * заглушки к содержимому не двигал экран: шапка, герой (NOVA Score — четыре
 * плитки со сводкой в центре), разбор коуча, лента плана, быстрые действия и
 * блок направления (путь плюс фокус дня одной карточкой).
 *
...
export function DashboardSkeleton() {
  return (
    <div className="flex flex-col gap-5">
      ...
      {/* Герой: подпись и сетка 2×2 из плиток со сводкой в центре. */}
