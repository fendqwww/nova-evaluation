...
import { Home, Target, Repeat, ListTodo, Sparkles, User } from "lucide-react";
...
//
// Коуч sits between Задачи and Профиль rather than at the end: the first four
// tabs are the things you *do*, and the Coach is what reads them — putting it
// after Профиль would file it as a settings screen.
